...
import static modul4.tugas.com.main.Main.daftarBuku;
...
public class Student extends User implements iMenu {
    ...
    public void choiceBook(Book[] bookList) {
        daftarBuku[i++] = new StoryBook("SB32F", "Sultan Hasanuddin", 17, "Story", "Fahmi");
        daftarBuku[i++] = new HistoryBook("HB324", "Sunan Ampel", 2, "History", "Fahmi");
        daftarBuku[i++] = new TextBook("TB323", "Aru Palakka", 4, "Text", "Fahmi");
