...
public class Student extends User implements iMenu {
    ...
    public void choiceBook(ArrayList<Book> bookList) {
        daftarBuku.add(new StoryBook("SB32F", "Sultan Hasanuddin", 17, "Story", "Fahmi"));
        daftarBuku.add(new HistoryBook("Sunan Ampel", 2, "History", "Fahmi"));
        daftarBuku.add(new TextBook("TB323", "Aru Palakka", 4, "Text", "Fahmi"));
